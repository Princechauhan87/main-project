...
export default function Edit() {
  ...
  const handleSubmit = (e) => {
    ...
    const users = JSON.parse(localStorage.getItem("managedUsers") || "[]");
    const updated = users.map((u) => (String(u.id) === String(id) ? { ...u, ...form } : u));
    localStorage.setItem("managedUsers", JSON.stringify(updated));
    navigate("/dashboard");
  };
  ...
  if (notFound) {
    return (
      <div className="page-wrap">
        <div className="page-inner" style={{ maxWidth: 520, textAlign: "center" }}>
          <p style={{ color: "#fff", fontSize: 15 }}>User not found.</p>
      ...
      <div className="page-inner" style={{ maxWidth: 520 }}>
        ...
        <div className="form-card">
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20 }}>
            ...
            <h2 style={{ margin: 0, fontSize: 18, fontWeight: 700, color: "#111827" }}>Edit user</h2>
          </div>
